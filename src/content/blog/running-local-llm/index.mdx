...
1) **Privacy**: Cloud LLM providers own your data when you upload them to their servers and this information can be leaked by clever manipulative prompts. There are some plans which restrict sharing of data but there is always a risk.
