          ...
          <section className="contact-container lg:w-[54rem] mx-2">
            <div className="contact-left pr-4">
              ...
              <div className='markdown-text'>
                ...
                <p>If you would like to communicate with end-to-end encryption, please use the email and public key published on the <a href="https://keys.openpgp.org/search?q=contact@timothynewman.co.uk">OpenPGP directory</a>.</p>
              </div>
              <SocialMedias />
            </div>
